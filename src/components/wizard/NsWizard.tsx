...
import { NsErrors } from '../components/NsErrors';
import { NsModal } from '../components/NsModal';
import { NsFormWrapper } from '../components/form/NsFormWrapper';
...
export interface NsWizardProps<T = unknown> {
   ...
   */
  children: NsWizardStepType | NsWizardStepType[] | any;
  /**
 ...
 */
export const NsWizardProgressButtons: React.FC<
  NsWizardProgressButtonsProps
> = ({ onPrev, onNext }) => {
...
export type NsWizardStepProps<T = unknown> = React.PropsWithChildren<
  NsWizardStepPropsBase<T>
>;
