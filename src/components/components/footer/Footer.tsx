...
import FooterMultiColumn from "../../components/footer/footers/FooterMultiColumn";
import FooterSimple from "../../components/footer/footers/FooterSimple";
...
export const Footer = ({type = "simple", logoPath, links, columns, rowSize}: FooterProps) => {
	if (type === "simple") {
		return (
