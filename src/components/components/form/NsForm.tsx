...
export interface NsFormProps<T extends Object> {
     ...
     *
     * Example usage:
     * `<NsForm buttonsSlot={<CustomButtonComponent />} />`
     *
 ...
 */
export const NsForm = <T extends Object>({
    name,
    onSubmit,
    onReset,
    sx,
...
export const CustomTestButtons = <T extends Object>({ submitText = 'Submit', resetText = 'Reset' }) => {
    const { t } = useTranslation();
    const { onSubmit, onReset } = useFormContext();
