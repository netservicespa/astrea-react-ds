...
const Template: StoryFn<typeof NsWizard> = ({ sx, StepperSlot }) => {
    ...
    const [customCallback, setCustomCallback] = React.useState('');

    const handleField1Change = (arg) => {
        console.log('RISULTATO DELLA CUTOMCALL (arg):', arg);
    };
    if (finished) {
        return (
        ...
        return (
            <>
                <Container maxWidth={false}>
                    <Typography>customCallback: {customCallback}</Typography>
                </Container>
                <NsWizard
                    sx={sx}
                ...
                >
                    <NsWizardFormStep name="First Step" icon={EditIcon} onStepCallback={handleField1Change}>
                        ...
                        <NsGridLayout rowSize={1}>
                            ...
                            />
                            <NsCheckbox name="check1" label={t('Check 1')} defaultChecked={data?.check1} />
                            <NsFileUpload
                                displayForm
                    ...
                    <NsWizardFormStep name="Second Step" icon={DataObjectSharp}>
                        ...
                        <NsGridLayout rowSize={1}>
                            <NsTextInput name="field3" label={t('Field 3')} defaultValue={data?.field3} />
...
const CustomStepper: React.FC<NsWizardStepperProps> = ({ steps, activeStep, icons }) => {
