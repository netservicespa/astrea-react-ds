// NsTableAdvanced.stories.tsx
import React from 'react';
import { Meta, StoryFn } from '@storybook/react';
import { NsTableAdvanced, NsTableProps } from '../../components/components/table/NsTable';
...
export default {
  ...
  component: NsTableAdvanced,
  argTypes: {
    onFrameClick: { action: 'onFrameClick' }
  }
} as Meta;

const Template: StoryFn<NsTableProps<ExampleDataType>> = (args) => <NsTableAdvanced {...args} />;
