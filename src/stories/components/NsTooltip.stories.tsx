...
export default {
  ...
  argTypes: {
    title: {
      description:
        'The content of the tooltip. Can be a string or a React node.',
      control: 'text',
      table: {
        category: 'Content',
      },
    ...
    placement: {
      description:
        'Defines where to place the tooltip relative to the target element.',
      control: {
        type: 'select',
        options: [
          'bottom',
    ...
    icon: {
      description:
        'Icon to be displayed in the tooltip. If not provided, a default icon will be used.',
      control: 'object',
      table: {
        category: 'Appearance',
      },
    ...
    otherProps: {
      description:
        'Other properties to be passed to the tooltip for additional customization.',
      control: 'object',
      table: {
        category: 'Misc',
      },
