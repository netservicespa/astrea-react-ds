            ...
            borderWidth: '3px',
                    ...
                    '&.Mui-checked': {
                        '& svg': {
                            ...
                            '& path': {
                                d: "path('M5 16.577l2.194-2.195 5.486 5.484L24.804 7.743 27 9.937l-14.32 14.32z')",
                                position: 'relative',
                                top: '50%',
                                left: '50%',
...
// @ts-ignore
export const AstreaTheme = responsiveFontSizes(createTheme(themeOptions, itIT, coreItIT));
